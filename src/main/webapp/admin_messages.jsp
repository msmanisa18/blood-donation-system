<%@page import="com.bds.bean.ContactUsBean"%>
...
<%
	...
	if (session == null || session.getAttribute("userName") == null) {
		...
		messageList = (List)session.getAttribute("messageList");
	}
%>
  ...
  <body>
    ...
    <div class="main">
    	<header>
	        ...
	        <h2>Messages received from Contact Us page</h2>
	        <div class="user-info">
      ...
      <section class="table-section">
        <table>
          ...
          <tbody>
            ...
            <%
            	if (null != messageList) {
            		for (ContactUsBean bean : messageList) {
            %>    
            <tr>        		
            	<td> <% out.print(bean.getUserName()); %> </td>
            	<td> <% out.print(bean.getUserEmail()); %> </td>
            	<td> <% out.print(bean.getUserMob()); %> </td>
            	<td> <% out.print(bean.getUserMsg()); %> </td>
            </tr>
            <%
            		}
            	}
